        ...
        return (
            <div className='about_container'>
              ...
              <p className='about_heading'><b>About me</b></p>
                <p className='about_content'>Hey there! I'm Andy, a graduating senior at <a className='link' href="https://independence.esuhsd.org/">Independence High School</a> and an incoming freshman at MIT. </p>
              ...
              <p className='about_heading'><b>Favorites</b></p>
                <p className='about_content'>Visual media (movie/films, anime/manga, k-dramas, etc):</p>
