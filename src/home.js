        ...
        return (
            <div className='homepg_container'>
              ...
              <div ref={this.intro_ref} id='intro_container'>
                  <p id='intro'>
                  Hey there👋<br/><br/>I'm Andy, a graduating senior at <a className='link' href="https://independence.esuhsd.org/">IHS</a> and an incoming freshman at <a className='link' href="https://bcs.mit.edu/academic-program/course-6-9-computation-and-cognition">MIT</a>. Right now, I'm interested in how we can better understand both machine & human learning—and how we can use what we uncover to tackle challenges that, at a fundamental level, impact people. 
                  <br/><br/>When not grinding out a <a className='link' href="https://abstracts.societyforscience.org/Home/FullAbstract?Category=Any%20Category&Finalist=Phung&AllAbstracts=False&FairCountry=Any%20Country&FairState=Any%20State&ProjectId=22557">research paper</a> or hacking together <a className='link' href="https://drive.google.com/file/d/1AabddkhmL6tfaJodaLs_v7LHey3tdaGy/view?usp=sharing">some</a> <a className='link' href="https://drive.google.com/file/d/1AqL24aO-NCKtkd9No5pQAFHJmcvlsG_Q/view?usp=sharing">troll</a> <a className='link' href="https://github.com/hackclub/winter/blob/main/andy-phung.md">project</a> (that may or may not double as <a className='link' href="https://github.com/hackclub/winter/blob/main/andy-phung.md#ramen-lamp">a piece of art</a>), I binge <a className='link' href="http://andyphung.dev/about#visual_media_favs">movies & k-dramas</a>, try my hand at Asian dishes, dabble in design, and think about life. 
                  <br/><br/>I love meeting new people from all walks of life—if you're in the area, <a className='link' href='https://www.instagram.com/andy.ipynb/'>come say hi</a>!
